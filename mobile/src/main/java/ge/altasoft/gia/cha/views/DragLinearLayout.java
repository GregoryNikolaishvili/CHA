...
public final class DragLinearLayout extends LinearLayout {
    ...
    private class DraggableChild {
        /**
         * If non-null, a reference to an on-going position pump_animation.
         */
    ...
    public void setViewNonDraggable(View child) {
        if (this == child.getParent()) {
    ...
    private void startDrag() {
        // remove layout transition, it conflicts with drag pump_animation
        // we will restore it after drag pump_animation end, see onDragStop()
    ...
    /**
     * Updates the dragged item with the given total onOffset from its starting position.
        ...
        if (isBelow || isAbove) {
            ...
            observer.addOnPreDrawListener(new OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    // we may need to update an ongoing settle pump_animation
                    if (draggedItem.settling()) {
                        Log.d(LOG_TAG, "Updating settle pump_animation");
